...
<div class="panel">
  ...
  <p>
    V10-B 修復版：可輸入「本課生字」，按「套用生字」後，生字會自動變成只顯示注音，其餘字保留國字＋注音。<br>
...
function loadCurrentLesson(){
  ...
  document.getElementById("words").value = lesson.text || "";

  if(Array.isArray(lesson.newWords)){
    document.getElementById("lessonChars").value = lesson.newWords.join(" ");
  }else{
    document.getElementById("lessonChars").value = "";
  }
